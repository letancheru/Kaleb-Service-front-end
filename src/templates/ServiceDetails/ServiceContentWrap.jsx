                ...
                <div className="service-details-info">
                    ...
                    <div className="pagination-wrap">
                        <ul className="pagination">
                            <li className="prev">
                                <a href={`/service/${prevService.title.split(' ').join('-').toLocaleLowerCase()}?id=${prevService.id}}`}
                            ...
                            <li className="next">
                                <a href={`/service/${nextService.title.split(' ').join('-').toLocaleLowerCase()}?id=${nextService.id}}`}
